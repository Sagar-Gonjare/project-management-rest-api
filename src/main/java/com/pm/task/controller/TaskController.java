...
import com.pm.task.service.TaskServiceImpl;
...
public class TaskController {
  ...
  public ResponseEntity<TaskResponse> create(
      @PathVariable("projectId") Long projectId, @Valid @RequestBody TaskCreateRequest req) {
  ...
  public ResponseEntity<Page<TaskResponse>> list(
      ...
      @RequestParam(name = "dueDateFrom", required = false)
          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          LocalDate dueDateFrom,
      @RequestParam(name = "dueDateTo", required = false)
          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          LocalDate dueDateTo,
      Pageable pageable) {
    return ResponseEntity.ok(
        service.list(projectId, status, priority, dueDateFrom, dueDateTo, pageable));
  }
